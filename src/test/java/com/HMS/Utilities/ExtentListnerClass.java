...
public class ExtentListnerClass implements ITestListener {
	...
	public void configureReports()
	{
		...
		String reportName = "Hospital Managment Test Report" + timestamp + ".html";
		htmlReporter = new ExtentSparkReporter(System.getProperty("user.dir") + "//Reports_HMS//" + reportName);
		...
		htmlReporter.config().setReportName("Reports on HMS");
